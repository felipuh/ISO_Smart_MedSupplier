# QA Testing Gate - ISO Smart MedSupplier

Date: 2026-07-03

## Official Local Gate

Run from `/home/felipe/proyectos/ISO_Smart_MedSupplier/backend`:
...
Run from `/home/felipe/proyectos/ISO_Smart_MedSupplier/frontend`:
...
```sql
ALTER ROLE medsupplier_user CREATEDB;
```
