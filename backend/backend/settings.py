...
# AdminApps remains the authority for organizations, users and entitlements.
MEDSUPPLIER_PRODUCT_MODE = os.getenv('MEDSUPPLIER_PRODUCT_MODE', 'integrated').strip().lower()
